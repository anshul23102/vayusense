...
- The full, unfiltered **36-city ranking table** (correctly *not* curated here — this is the command-center view)
...
| 🗺️ **Curated landing grid** | The landing page shows the real worst-8 cities right now, not all 36 — the dashboard's job — with a clear path to "see all" |
